...
#define Y_DECALAGE_EVITEMENT		1.5
...
if(  (obstacleAssignment.ObstacleFusion[k].NbrOccupiedLane == 1) 
   &&(obstacleAssignment.ObstacleFusion[k].distanceCurviligne > -20.0) && (obstacleAssignment.ObstacleFusion[k].distanceCurviligne < 20.0)){
