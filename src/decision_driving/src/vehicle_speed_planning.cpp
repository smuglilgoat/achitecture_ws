...
int main(int argc, char** argv)
{
	...
	ros::Publisher pub_vehicle_position_offset = n.advertise<std_msgs::Float64>(std::string("/vehicle_position_offset"), 1);  // added
  	...
  	while(n.ok())
	{
		...
		std_msgs::Float64 position_offset;  //Added
		position_offset.data= roadModel.electronicHorizon.ehPosition.offset.data ;  // Added
		
 
		pub_vehicle_position_offset.publish(position_offset); // Added
