        ...
        topic_type_(topic_type)
{
  ...
  connect(this, SIGNAL(adjustLCDNumberOfDigits(const long unsigned)), this,
          SLOT(adjustLCDNumberOfDigitsHandler(const long unsigned)));
}
...
{
  QString label(QString::number(msg->data.sec));
  label.append(" sec, ");
  label.append(QString::number(msg->data.nsec));
  label.append(" nsec");
