						...
						project_s_msgs::RoutePlanning Route_Planning_data)
{
	...
	else	// DEMO MODE
	{
		...
		else
		{
			...
			cerr << "Warning : Route_Planning GPS_droite array size > Electronic_Horizon ehSpotCoordGeo array size!" << endl;
		}
		...
		else
		{
			...
			cerr << "Warning : Route_Planning GPS_gauche array size > Electronic_Horizon ehSpotCoordGeo array size!" << endl;
		}
