						...
						project_s_msgs::RoutePlanning Route_Planning_data)
{
	...
	const unsigned int ME_LINE_ARRAY_SIZE = sizeof(electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo) / sizeof(electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[0]);
	const unsigned int ME_LINE_SEGMENT_ARRAY_SIZE = sizeof(electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME) / sizeof(electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[0]);
	...
	else	// DEMO MODE
	{
		...
		{
			electronic_Horizon_data.PathsArray[0].NbrSegment.data = SPEED_ARRAY_SIZE;
			cerr << "Warning : Route_Planning speed limit array size > Electronic_Horizon ehSegment speed limit array size!" << endl;
		}
		...
		else
		{
			...
			cerr << "Warning : Route_Planning curvature array size > Electronic_Horizon ehSpotCurvature array size!" << endl;
		}
		...
		else
		{
			...
			cerr << "Warning : Route_Planning GPS_droite array size > Electronic_Horizon LineCoordGeo ehSpotCoordGeo array size!" << endl;
		}
		...
		else
		{
			...
			cerr << "Warning : Route_Planning GPS_gauche array size > Electronic_Horizon LineCoordGeo ehSpotCoordGeo array size!" << endl;
		}
		...
		unsigned int ehME_QtySegment = 0;
		
		if (Route_Planning_data.Tableau_circuit_GPS_MEdroite.size() > 0)
		{
			electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[0].latitude = Route_Planning_data.Tableau_circuit_GPS_MEdroite[0].latitude;

			electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[0].longitude = Route_Planning_data.Tableau_circuit_GPS_MEdroite[0].longitude;

			electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[0].offset.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite[0].offset;
			
			electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[0].offset_debut.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite[0].offset;
			electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[0].NbrSpot.data = 1;
			ehME_QtySegment++;
			
			int i = 1;
			for (; i < Route_Planning_data.Tableau_circuit_GPS_MEdroite.size() && i < ME_LINE_ARRAY_SIZE; i++)
			{
				electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[i].latitude = Route_Planning_data.Tableau_circuit_GPS_MEdroite[i].latitude;

				electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[i].longitude = Route_Planning_data.Tableau_circuit_GPS_MEdroite[i].longitude;

				electronic_Horizon_data.PathsArray[0].ehME[0].ehSpotCoordGeo[i].offset.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite[i].offset;
				
				if (Route_Planning_data.Tableau_circuit_GPS_MEdroite[i].offset - Route_Planning_data.Tableau_circuit_GPS_MEdroite[i - 1].offset < ECART)
				{
					electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[ehME_QtySegment - 1].NbrSpot.data++;
				}
				else
				{
					electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[ehME_QtySegment - 1].offset_fin.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite[i - 1].offset;
					
					if (ehME_QtySegment < ME_LINE_SEGMENT_ARRAY_SIZE)
					{
						electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[ehME_QtySegment].offset_debut.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite[i].offset;
						electronic_Horizon_data.PathsArray[0].ehME[0].ehSegmentME[ehME_QtySegment].NbrSpot.data = 1;
					}
					else
					{
						cerr << "Warning : Electronic_Horizon_ehME_ehSegmentME array size < ehME_QtySegment !" << endl;
					}
		...
		electronic_Horizon_data.PathsArray[0].ehME[0].QtySegment.data = ehME_QtySegment;
		
		if (Route_Planning_data.Tableau_circuit_GPS_MEdroite.size() < ME_LINE_ARRAY_SIZE)
		{
			electronic_Horizon_data.PathsArray[0].ehME[0].NbrSpotCoordGeo.data = Route_Planning_data.Tableau_circuit_GPS_MEdroite.size();
		}
		else
		{
			electronic_Horizon_data.PathsArray[0].ehME[0].NbrSpotCoordGeo.data = ME_LINE_ARRAY_SIZE;
			cerr << "Warning : Route_Planning GPS_MEdroite array size > Electronic_Horizon ehME ehSpotCoordGeo array size!" << endl;
		}
		...
		if (Route_Planning_data.Tableau_circuit_GPS_MEgauche.size() > 0)
		{
			electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[0].latitude = Route_Planning_data.Tableau_circuit_GPS_MEgauche[0].latitude;

			electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[0].longitude = Route_Planning_data.Tableau_circuit_GPS_MEgauche[0].longitude;

			electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[0].offset.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche[0].offset;

			electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[0].offset_debut.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche[0].offset;
			electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[0].NbrSpot.data = 1;
			ehME_QtySegment++;
			
			int i = 1;
			for (; i < Route_Planning_data.Tableau_circuit_GPS_MEgauche.size() && i < ME_LINE_ARRAY_SIZE; i++)
			{
				electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[i].latitude = Route_Planning_data.Tableau_circuit_GPS_MEgauche[i].latitude;

				electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[i].longitude = Route_Planning_data.Tableau_circuit_GPS_MEgauche[i].longitude;

				electronic_Horizon_data.PathsArray[0].ehME[1].ehSpotCoordGeo[i].offset.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche[i].offset;
				
				if (Route_Planning_data.Tableau_circuit_GPS_MEgauche[i].offset - Route_Planning_data.Tableau_circuit_GPS_MEgauche[i - 1].offset < ECART)
				{
					electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[ehME_QtySegment - 1].NbrSpot.data++;
				}
				else
				{
					electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[ehME_QtySegment - 1].offset_fin.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche[i - 1].offset;
					
					if (ehME_QtySegment < ME_LINE_SEGMENT_ARRAY_SIZE)
					{
						electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[ehME_QtySegment].offset_debut.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche[i].offset;
						electronic_Horizon_data.PathsArray[0].ehME[1].ehSegmentME[ehME_QtySegment].NbrSpot.data = 1;
					}
					else
					{
						cerr << "Warning : Electronic_Horizon_ehME_ehSegmentME array size < ehME_QtySegment !" << endl;
		...
		electronic_Horizon_data.PathsArray[0].ehME[1].QtySegment.data = ehME_QtySegment;
		
		if (Route_Planning_data.Tableau_circuit_GPS_MEgauche.size() < ME_LINE_ARRAY_SIZE)
		{
			electronic_Horizon_data.PathsArray[0].ehME[1].NbrSpotCoordGeo.data = Route_Planning_data.Tableau_circuit_GPS_MEgauche.size();
		}
		else
		{
			electronic_Horizon_data.PathsArray[0].ehME[1].NbrSpotCoordGeo.data = ME_LINE_ARRAY_SIZE;
			cerr << "Warning : Route_Planning GPS_MEgauche array size > Electronic_Horizon ehME ehSpotCoordGeo array size!" << endl;
		}
		...
		else
		{
			...
			cerr << "Warning : Route_Planning traffic sign array size > Electronic_Horizon ehSpotTrafficSign array size!" << endl;
		}


	const unsigned int EH_SEGMENT_AO_ARRAY_SIZE = sizeof(electronic_Horizon_data.PathsArray[0].ehSegmentAO) / sizeof(electronic_Horizon_data.PathsArray[0].ehSegmentAO[0]);


		for (int i = 0; i < Route_Planning_data.Tableau_circuit_ehSegmentAO.size() && i < EH_SEGMENT_AO_ARRAY_SIZE; i++)
		{
			electronic_Horizon_data.PathsArray[0].ehSegmentAO[i].NbrSpot.data = Route_Planning_data.Tableau_circuit_ehSegmentAO[i].NbrSpot;

			electronic_Horizon_data.PathsArray[0].ehSegmentAO[i].offset_debut.data = Route_Planning_data.Tableau_circuit_ehSegmentAO[i].offset_debut;

			electronic_Horizon_data.PathsArray[0].ehSegmentAO[i].offset_fin.data = Route_Planning_data.Tableau_circuit_ehSegmentAO[i].offset_fin;
		}

		if (Route_Planning_data.Tableau_circuit_ehSegmentAO.size() < EH_SEGMENT_AO_ARRAY_SIZE)
		{
			electronic_Horizon_data.PathsArray[0].QtySegmentAO.data = Route_Planning_data.Tableau_circuit_ehSegmentAO.size();
		}
		else
		{
			electronic_Horizon_data.PathsArray[0].QtySegmentAO.data = EH_SEGMENT_AO_ARRAY_SIZE;
			cerr << "Warning : Route_Planning ehSegmentAO array size > Electronic_Horizon ehSegment EH_SEGMENT_AO array size!" << endl;
		}


	const unsigned int EH_SEGMENT_EO_ARRAY_SIZE = sizeof(electronic_Horizon_data.PathsArray[0].ehSegmentEO) / sizeof(electronic_Horizon_data.PathsArray[0].ehSegmentEO[0]);


		for (int i = 0; i < Route_Planning_data.Tableau_circuit_ehSegmentEO.size() && i < EH_SEGMENT_EO_ARRAY_SIZE; i++)
		{
			electronic_Horizon_data.PathsArray[0].ehSegmentEO[i].NbrSpot.data = Route_Planning_data.Tableau_circuit_ehSegmentEO[i].NbrSpot;

			electronic_Horizon_data.PathsArray[0].ehSegmentEO[i].offset_debut.data = Route_Planning_data.Tableau_circuit_ehSegmentEO[i].offset_debut;

			electronic_Horizon_data.PathsArray[0].ehSegmentEO[i].offset_fin.data = Route_Planning_data.Tableau_circuit_ehSegmentEO[i].offset_fin;
		}

		if (Route_Planning_data.Tableau_circuit_ehSegmentEO.size() < EH_SEGMENT_EO_ARRAY_SIZE)
		{
			electronic_Horizon_data.PathsArray[0].QtySegmentEO.data = Route_Planning_data.Tableau_circuit_ehSegmentEO.size();
		}
		else
		{
			electronic_Horizon_data.PathsArray[0].QtySegmentEO.data = EH_SEGMENT_EO_ARRAY_SIZE;
			cerr << "Warning : Route_Planning ehSegmentEO array size > Electronic_Horizon ehSegment EH_SEGMENT_EO array size!" << endl;
		}
