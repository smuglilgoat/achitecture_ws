...
int main(int argc, char *argv[])
{
	...
	int choice(0);
	while (choice < 1 || choice > TRACKS_NB)
	{
		cout << "Please choose a itinerary between 1 and 10:\n";
		cout << "1 - Itinerary 1 + Trappes + Av. Jean d'Alembert\n";
		cout << "2 - Itinerary 2 + Trappes + R.-P. Marechal Leclerc\n";
		cout << "3 - Itinerary 4 + Elancourt + R. Copenhague - Bd Jean Moulin\n";
		cout << "4 - Itinerary 5 + Elancourt + R. Copenhague - Bd Helsinki\n";
		cout << "5 - Itinerary 7 + Trappes + Rue de Montfort\n";
		cout << "6 - Itinerary Trappes Segula parking lot\n";
		cout << "7 - Itinerary Trappes Segula parking lot - Circuit Oval\n";
	...
	while (n.ok())
	{
		//if (error)
		{
			error = route_planning(Route_Planning_data, choice);
