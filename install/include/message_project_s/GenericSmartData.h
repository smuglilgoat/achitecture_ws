// Generated by gencpp from file message_project_s/GenericSmartData.msg
// DO NOT EDIT!


#ifndef MESSAGE_PROJECT_S_MESSAGE_GENERICSMARTDATA_H
#define MESSAGE_PROJECT_S_MESSAGE_GENERICSMARTDATA_H
...
struct GenericSmartData_
{
  ...
  typedef boost::shared_ptr< ::message_project_s::GenericSmartData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::message_project_s::GenericSmartData_<ContainerAllocator> const> ConstPtr;

}; // struct GenericSmartData_

typedef ::message_project_s::GenericSmartData_<std::allocator<void> > GenericSmartData;

typedef boost::shared_ptr< ::message_project_s::GenericSmartData > GenericSmartDataPtr;
typedef boost::shared_ptr< ::message_project_s::GenericSmartData const> GenericSmartDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::message_project_s::GenericSmartData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::message_project_s::GenericSmartData_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::message_project_s::GenericSmartData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::message_project_s::GenericSmartData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::message_project_s::GenericSmartData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::message_project_s::GenericSmartData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::message_project_s::GenericSmartData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::message_project_s::GenericSmartData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::message_project_s::GenericSmartData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::message_project_s::GenericSmartData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x79cccb639db4b52cULL;
  static const uint64_t static_value2 = 0xcd3188161e904867ULL;
};

template<class ContainerAllocator>
struct DataType< ::message_project_s::GenericSmartData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::message_project_s::GenericSmartData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::message_project_s::GenericSmartData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::message_project_s::GenericSmartData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::message_project_s::GenericSmartData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MESSAGE_PROJECT_S_MESSAGE_GENERICSMARTDATA_H
