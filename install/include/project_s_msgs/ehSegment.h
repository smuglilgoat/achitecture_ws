// Generated by gencpp from file project_s_msgs/ehSegment.msg
// DO NOT EDIT!


#ifndef PROJECT_S_MSGS_MESSAGE_EHSEGMENT_H
#define PROJECT_S_MSGS_MESSAGE_EHSEGMENT_H
...
struct ehSegment_
{
  typedef ehSegment_<ContainerAllocator> Type;
  ...
  ehSegment_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , id(_alloc)
    , offset(_alloc)
    , functionRoadClass(_alloc)
    , wayForm(_alloc)
    , effectiveSpeedLimit(_alloc)
  ...
  _wayForm_type wayForm;
   ...
   typedef  ::std_msgs::UInt8_<ContainerAllocator>  _effectiveSpeedLimit_type;
  ...
  typedef boost::shared_ptr< ::project_s_msgs::ehSegment_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::project_s_msgs::ehSegment_<ContainerAllocator> const> ConstPtr;

}; // struct ehSegment_

typedef ::project_s_msgs::ehSegment_<std::allocator<void> > ehSegment;

typedef boost::shared_ptr< ::project_s_msgs::ehSegment > ehSegmentPtr;
typedef boost::shared_ptr< ::project_s_msgs::ehSegment const> ehSegmentConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::project_s_msgs::ehSegment_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::project_s_msgs::ehSegment_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ehSegment_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ehSegment_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ehSegment_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ehSegment_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ehSegment_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ehSegment_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::project_s_msgs::ehSegment_<ContainerAllocator> >
{
  ...
  static const char* value(const ::project_s_msgs::ehSegment_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6537588d17c4b842ULL;
  static const uint64_t static_value2 = 0x1cfde3df0a7fac39ULL;
};

template<class ContainerAllocator>
struct DataType< ::project_s_msgs::ehSegment_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::project_s_msgs::ehSegment_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::project_s_msgs::ehSegment_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::project_s_msgs::ehSegment_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::project_s_msgs::ehSegment_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::std_msgs::UInt8_<ContainerAllocator> >::stream(s, indent + "  ", v.effectiveSpeedLimit);
...
#endif // PROJECT_S_MSGS_MESSAGE_EHSEGMENT_H
