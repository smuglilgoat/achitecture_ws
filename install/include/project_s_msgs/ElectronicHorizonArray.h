// Generated by gencpp from file project_s_msgs/ElectronicHorizonArray.msg
// DO NOT EDIT!


#ifndef PROJECT_S_MSGS_MESSAGE_ELECTRONICHORIZONARRAY_H
#define PROJECT_S_MSGS_MESSAGE_ELECTRONICHORIZONARRAY_H
...
struct ElectronicHorizonArray_
{
  typedef ElectronicHorizonArray_<ContainerAllocator> Type;

  ElectronicHorizonArray_()
    : header()
    , id()
    , PathsArray()
    , NbrPath()
  ...
  ElectronicHorizonArray_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , id(_alloc)
    , PathsArray()
    , NbrPath(_alloc)
    ...
    , odom(_alloc)  {
  (void)_alloc;
      PathsArray.assign( ::project_s_msgs::ElectronicHorizon_<ContainerAllocator> (_alloc));
  }
  ...
  _id_type id;
   ...
   typedef boost::array< ::project_s_msgs::ElectronicHorizon_<ContainerAllocator> , 5>  _PathsArray_type;
  _PathsArray_type PathsArray;

   typedef  ::std_msgs::UInt8_<ContainerAllocator>  _NbrPath_type;
  _NbrPath_type NbrPath;

   typedef  ::std_msgs::UInt8_<ContainerAllocator>  _indexMPP_type;
  _indexMPP_type indexMPP;
  ...
  typedef boost::shared_ptr< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> const> ConstPtr;

}; // struct ElectronicHorizonArray_

typedef ::project_s_msgs::ElectronicHorizonArray_<std::allocator<void> > ElectronicHorizonArray;

typedef boost::shared_ptr< ::project_s_msgs::ElectronicHorizonArray > ElectronicHorizonArrayPtr;
typedef boost::shared_ptr< ::project_s_msgs::ElectronicHorizonArray const> ElectronicHorizonArrayConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
{
  ...
  static const char* value(const ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1944698f685c5272ULL;
  static const uint64_t static_value2 = 0xc5b7372763d0c8f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.header);
      stream.next(m.id);
      stream.next(m.PathsArray);
      stream.next(m.NbrPath);
      stream.next(m.indexMPP);
      stream.next(m.odom);
    }
...
template<class ContainerAllocator>
struct Printer< ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::project_s_msgs::ElectronicHorizonArray_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "PathsArray[]" << std::endl;
    for (size_t i = 0; i < v.PathsArray.size(); ++i)
    {
      s << indent << "  PathsArray[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::project_s_msgs::ElectronicHorizon_<ContainerAllocator> >::stream(s, indent + "    ", v.PathsArray[i]);
    }
    s << indent << "NbrPath: ";
    s << std::endl;
    Printer< ::std_msgs::UInt8_<ContainerAllocator> >::stream(s, indent + "  ", v.NbrPath);
    s << indent << "indexMPP: ";
    s << std::endl;
    Printer< ::std_msgs::UInt8_<ContainerAllocator> >::stream(s, indent + "  ", v.indexMPP);
    s << indent << "odom: ";
    s << std::endl;
...
#endif // PROJECT_S_MSGS_MESSAGE_ELECTRONICHORIZONARRAY_H
