// Generated by gencpp from file project_s_msgs/ObstacleFusionReport.msg
// DO NOT EDIT!


#ifndef PROJECT_S_MSGS_MESSAGE_OBSTACLEFUSIONREPORT_H
#define PROJECT_S_MSGS_MESSAGE_OBSTACLEFUSIONREPORT_H
...
struct ObstacleFusionReport_
{
  typedef ObstacleFusionReport_<ContainerAllocator> Type;

  ObstacleFusionReport_()
    : header()
    , id()
    , ObstacleFusion()
    , QtyObstacles()
  ...
  ObstacleFusionReport_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , id(_alloc)
    , ObstacleFusion()
    , QtyObstacles(_alloc)
    , odom(_alloc)  {
  (void)_alloc;
      ObstacleFusion.assign( ::project_s_msgs::ObstacleFusion_<ContainerAllocator> (_alloc));
  }
  ...
  _id_type id;
   ...
   typedef boost::array< ::project_s_msgs::ObstacleFusion_<ContainerAllocator> , 127>  _ObstacleFusion_type;
  _ObstacleFusion_type ObstacleFusion;
  ...
  enum {
    OBSTACLE_FUSION_REPORT_SIZE = 127u,
  };


  typedef boost::shared_ptr< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> const> ConstPtr;

}; // struct ObstacleFusionReport_

typedef ::project_s_msgs::ObstacleFusionReport_<std::allocator<void> > ObstacleFusionReport;

typedef boost::shared_ptr< ::project_s_msgs::ObstacleFusionReport > ObstacleFusionReportPtr;
typedef boost::shared_ptr< ::project_s_msgs::ObstacleFusionReport const> ObstacleFusionReportConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
{
  ...
  static const char* value(const ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x699d031838fdda96ULL;
  static const uint64_t static_value2 = 0x7f55404a6c4b9748ULL;
};

template<class ContainerAllocator>
struct DataType< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.header);
      stream.next(m.id);
      stream.next(m.ObstacleFusion);
...
template<class ContainerAllocator>
struct Printer< ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::project_s_msgs::ObstacleFusionReport_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "ObstacleFusion[]" << std::endl;
    for (size_t i = 0; i < v.ObstacleFusion.size(); ++i)
    {
      s << indent << "  ObstacleFusion[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::project_s_msgs::ObstacleFusion_<ContainerAllocator> >::stream(s, indent + "    ", v.ObstacleFusion[i]);
    }
...
#endif // PROJECT_S_MSGS_MESSAGE_OBSTACLEFUSIONREPORT_H
