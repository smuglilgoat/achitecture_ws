...
class ObstacleAlignment_1 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('visionOnlySignType')) {
        this.visionOnlySignType = initObj.visionOnlySignType
      }
      else {
        this.visionOnlySignType = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [visionOnlySignType]
    bufferOffset = _serializer.uint8(obj.visionOnlySignType, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ObstacleAlignment_1(null);
    ...
    // Deserialize message field [visionOnlySignType]
    data.visionOnlySignType = _deserializer.uint8(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ObstacleAlignment_1(null);
    ...
    if (msg.visionOnlySignType !== undefined) {
      resolved.visionOnlySignType = msg.visionOnlySignType;
    }
    else {
      resolved.visionOnlySignType = 0
    }
...
module.exports = ObstacleAlignment_1;
