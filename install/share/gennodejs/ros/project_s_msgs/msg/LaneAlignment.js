...
class LaneAlignment {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('dateAcquisition')) {
        ...
        this.dateAcquisition = new std_msgs.msg.UInt64();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = std_msgs.msg.UInt64.serialize(obj.dateAcquisition, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaneAlignment(null);
    ...
    data.dateAcquisition = std_msgs.msg.UInt64.deserialize(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'project_s_msgs/LaneAlignment';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '0ce9eca73df9d44131a505be2c05a4ea';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneAlignment(null);
    ...
    if (msg.dateAcquisition !== undefined) {
      resolved.dateAcquisition = std_msgs.msg.UInt64.Resolve(msg.dateAcquisition)
    }
    else {
      resolved.dateAcquisition = new std_msgs.msg.UInt64()
    }
...
LaneAlignment.Constants = {
  LINE_REPORT_SIZE: 20,
}

module.exports = LaneAlignment;
