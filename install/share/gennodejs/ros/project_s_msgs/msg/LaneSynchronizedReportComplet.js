...
class LaneSynchronizedReportComplet {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('linesUpdate')) {
        this.linesUpdate = initObj.linesUpdate
      }
      else {
        this.linesUpdate = new LaneFusion();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [linesUpdate]
    bufferOffset = LaneFusion.serialize(obj.linesUpdate, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LaneSynchronizedReportComplet(null);
    ...
    // Deserialize message field [linesUpdate]
    data.linesUpdate = LaneFusion.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LaneFusion.getMessageSize(object.linesUpdate);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneSynchronizedReportComplet(null);
    ...
    if (msg.linesUpdate !== undefined) {
      resolved.linesUpdate = LaneFusion.Resolve(msg.linesUpdate)
    }
    else {
      resolved.linesUpdate = new LaneFusion()
    }
...
module.exports = LaneSynchronizedReportComplet;
