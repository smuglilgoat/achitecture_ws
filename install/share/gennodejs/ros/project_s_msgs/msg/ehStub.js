...
class ehStub {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('indexSubPath')) {
        this.indexSubPath = initObj.indexSubPath
      }
      else {
        this.indexSubPath = new std_msgs.msg.UInt8();
      }
      if (initObj.hasOwnProperty('turnAngle')) {
        this.turnAngle = initObj.turnAngle
      }
      else {
        this.turnAngle = new std_msgs.msg.Float32();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [indexSubPath]
    bufferOffset = std_msgs.msg.UInt8.serialize(obj.indexSubPath, buffer, bufferOffset);
    // Serialize message field [turnAngle]
    bufferOffset = std_msgs.msg.Float32.serialize(obj.turnAngle, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [indexSubPath]
    data.indexSubPath = std_msgs.msg.UInt8.deserialize(buffer, bufferOffset);
    // Deserialize message field [turnAngle]
    data.turnAngle = std_msgs.msg.Float32.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ehStub(null);
    ...
    if (msg.indexSubPath !== undefined) {
      resolved.indexSubPath = std_msgs.msg.UInt8.Resolve(msg.indexSubPath)
    }
    else {
      resolved.indexSubPath = new std_msgs.msg.UInt8()
    }

    if (msg.turnAngle !== undefined) {
      resolved.turnAngle = std_msgs.msg.Float32.Resolve(msg.turnAngle)
    }
    else {
      resolved.turnAngle = new std_msgs.msg.Float32()
    }
