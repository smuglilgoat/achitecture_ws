...
(cl:defmethod cl:initialize-instance :after ((m <Time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name message_project_s-msg:<Time> is deprecated: use message_project_s-msg:Time instead.")))
...
(cl:defmethod Tn-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader message_project_s-msg:Tn-val is deprecated.  Use message_project_s-msg:Tn instead.")
  (Tn m))

(cl:ensure-generic-function 'Tn_1-val :lambda-list '(m))
(cl:defmethod Tn_1-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader message_project_s-msg:Tn_1-val is deprecated.  Use message_project_s-msg:Tn_1 instead.")
  (Tn_1 m))

(cl:ensure-generic-function 'Ti-val :lambda-list '(m))
(cl:defmethod Ti-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader message_project_s-msg:Ti-val is deprecated.  Use message_project_s-msg:Ti instead.")
  (Ti m))

(cl:ensure-generic-function 'iMIN-val :lambda-list '(m))
(cl:defmethod iMIN-val ((m <Time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader message_project_s-msg:iMIN-val is deprecated.  Use message_project_s-msg:iMIN instead.")
  (iMIN m))
