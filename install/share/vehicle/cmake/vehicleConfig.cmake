...
if("FALSE" STREQUAL "TRUE")
  set(vehicle_SOURCE_PREFIX /home/segula/Desktop/ava/achitecture_ws/src/vehicle)
  set(vehicle_DEVEL_PREFIX /home/segula/Desktop/ava/achitecture_ws/devel)
  set(vehicle_INSTALL_PREFIX "")
  set(vehicle_PREFIX ${vehicle_DEVEL_PREFIX})
else()
  set(vehicle_SOURCE_PREFIX "")
  set(vehicle_DEVEL_PREFIX "")
  set(vehicle_INSTALL_PREFIX /home/segula/Desktop/ava/achitecture_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/segula/Desktop/ava/achitecture_ws/install/${idir}'.  ${_report}")
    endif()
